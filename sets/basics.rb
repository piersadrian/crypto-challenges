...
set "Basics" do
  challenge "Convert hex to base64" do
    ...
    ::Convert.hash_to_base64(hex_str) == b64_str
  end
  ...
  challenge "Fixed XOR" do
    ...
    ::Convert.xor_hexes(hex_str1, hex_str2) == hex_res
  end


  challenge "Single-byte XOR cipher" do
    cipherhex   = "1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736"
    cipherbytes = ::Convert.hash_to_byte_array(cipherhex)

    best = ::Decrypt.find_single_char_key_and_decrypt(cipherbytes)
  ...
  challenge "Detect single-character XOR" do
    ...
    candidates  = hex_strings.map do |hex_string|
      ::Decrypt.find_single_char_key_and_decrypt( ::Convert.hash_to_byte_array(hex_string) )
    end
